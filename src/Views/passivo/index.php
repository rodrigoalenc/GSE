<section class="passivo-hero" aria-labelledby="passivo-summary-title">
    ...
    <div class="passivo-stats" aria-label="Resumo do Arquivo Passivo">
        ...
        <span><strong><?= e((string) $summary['pendentes']) ?></strong> localizações pendentes</span>
    </div>
</section>

<section class="relatorio passivo-toolbar" aria-labelledby="passivo-search-title">
    <div class="section-head">
        <div><h2 id="passivo-search-title">Busca e navegação</h2><p>Os caracteres %, _ e barra invertida são pesquisados literalmente.</p></div>
    ...
    <form class="passivo-filters" method="get" action="<?= e(url('passivo')) ?>">
        <div class="field-wide">
            <label for="passivo-q">Nome ou número</label>
            <input id="passivo-q" type="search" name="q" maxlength="<?= e((string) Passivo::SEARCH_MAX_LENGTH) ?>" value="<?= e($filters['q']) ?>" placeholder="Ex.: José da Silva ou 127">
        </div>
        <div>
        ...
        <div>
            ...
            <select id="passivo-ordem" name="ordem">
                ...
                <option value="numero" <?= $filters['ordem'] === 'numero' ? 'selected' : '' ?>>Número</option>
