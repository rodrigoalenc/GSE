...
final class AuditLogger
{
    ...
    public static function record(
        ...
        try {
            self::write(
                Database::getConnection(), $action, $result, $actorUserId, $targetUserId,
    ...
    /**
     * Registra auditoria dentro da transacao de dominio. Diferentemente de
     * record(), uma falha e propagada para que a operacao sensivel seja desfeita.
     */
    public static function recordRequired(
        PDO $pdo,
        string $action,
        string $result,
        ?int $actorUserId = null,
        ...
        self::write(
            $pdo, $action, $result, $actorUserId, $targetUserId,
            $description, $resourceType, $resourceId
        );
    }
